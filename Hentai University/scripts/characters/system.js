...
function writeEncounter(scene) {
	...
	switch (scene) {
		case "start" : {
			...
			// replace [\r\n]+ with , 
			writeText("Thank you to: Swallows999, Joshua Ingram, Madgunner, Robbie, CaptainMontana, Alex, andres mejia, Badaxe, Carlos, ChronosEdge, Colin E, Daniel Vivette, Dkells, dragoon48, Dustin Leichsenring, Filament, G, J_C_L, jack spencer, Jesse Greene, Jinouga, Keith, Macarga, Marc Maldon, Marco Wassmer, michael patrick murphy, Negativatron, Ramsey Bisher, Richard, Scal, Skyrim mod lvr, StormSight, Taylor Trout, XxrobothacksxX, 林家豪, Aegil, Alec8686, Andy Amundy, Angel, Anthony Ewing, Anthony Munso, Ariados, Blaise Fenn, Bonelessunknown, brandon, Carlos, Chaaaanon, Charles Morris, Daekash, Danny Nguyen, Darrell Goodman, DarthMalak, ddkre, Debarre Sonny, dhccpmc, Drashin, Dugelle, fireballcreations, GirmusCz, Grim2011, Gwen Yurick, Harry Brasch, ItsAllOgreNow, I'm a Mitch, Jane, joel larsen, John Lewis, john smith, Joshua Melzark, KH dg, Louis Hayes, Markus Hansen, mazterlith, murgatroid99, Nathan Vicary, Nils Maier, Noah, Nutburger, Phanes, Prodigal211, Roy, Scumstango, Sebastian Eckel, Simon Rencher, sky, SmolFish, Snaked, stratum, Tanman, Taurus Travon Rashad Lemar Brackin, Trevor, Vincent Madaire-Cullen, Wei, Wild Bill, William Richardson, Your Husbando, Z, 凱 陳, and 魏, for funding this work! The patreon funds are split as Captain Cryptogreek has taken over as lead writer for the game.");
