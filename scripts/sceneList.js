	...
	switch(scene) {
		case "start" : {
			document.getElementById('output').innerHTML +=`
				...
				<p class = "centeredText">Hentai University v12 Preview: https://www.patreon.com/posts/39585938</p>
				<p class = "centeredText">A quick preview of university v12, coming out on the 24th. It'll include scenes for Ash Martin and the new girl by crypto Nikki Hunt, hope you enjoy!</p>
