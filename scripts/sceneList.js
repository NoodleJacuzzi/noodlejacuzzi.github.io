	...
	switch(scene) {
		case "start" : {
			document.getElementById('output').innerHTML +=`
				<p class = "centeredText">Bonus News! 4/10/2020</p>
				<p class = "centeredText">Hentai University v9 Preview Available Here: https://www.patreon.com/posts/35878860</p>
			...
			writeText("Hentai University v8");
			...
			document.getElementById('output').innerHTML +=`
				<p class="choiceText" onclick="window.location.href='https://www.patreon.com/posts/35317697'">Download the game</p>
