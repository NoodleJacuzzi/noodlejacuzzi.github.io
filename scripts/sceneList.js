	...
	switch(scene) {
		case "start" : {
			document.getElementById('output').innerHTML +=`
				<p class = "centeredText">Lastest News 7/10/2020</p>
				<p class = "centeredText">Rainy DayZ v3 released: https://www.patreon.com/posts/39193031</p>
				<p class = "centeredText">v3.0 of Rainy DayZ is here, and Scenario 3: Spread Island is complete!</p>
