	...
	switch(scene) {
		case "start" : {
			document.getElementById('output').innerHTML +=`
				...
				<p class = "centeredText">Thank you to: Swallows999, Ben, Dover, CaptainMontana, Joshua, Ingram, MrManPerson, Robbie, Lasse, B, andres, mejia, Arthorias28, Badaxe, ChronosEdge, Colin, E, Jinouga, Judavarius, Lunarghost, Marco, Wassmer, Q, Q, Scal, Taylor, Trout, Adonnak, andy, Andy, Andy, Amundy, Angel, Anthony, AxiosMlles, Munso, Ariados, Arkhalis, Arthur, radcliffe, Auckard, Blaise, Fenn, Bobby, Hamilton, bono, brandon, Carlos, Chaaaanon, Charles, Morris, David, Lange, Debarre, Sonny, Devin, Dewr, dhccpmc, Drashin, Ed, Guy68691, Gwen, Yurick, iNoH8, , ItsAllOgreNow, Jacob, Cannon, Jane, jdktjk205, Jesse, Greene, joe, joe, joe, mulhall, john, smith, Joseph, Gibbs, Joshua, Melzark, Julia, Ferro, Karan, Raj, Gupta, LaCrazy, lm, Carma, Lucas, Molski, Luke, marvin, diaz, mazterlith, Mirza, Hasan, Monkey, murgatroid99, Nha, Nils, Maier, Nisi, Noah, Nutburger, Oliver, Jones, Philipp, Prodigal211, qwerty, Roy, Ryan, Linn, sage, Sebastian, Eckel, Shawn, sky, Skyrim, mod, lvr, Slipokk, Snaked, Steam, Screw, stratum, surgE, Taurus, Travon, Rashad, Lemar, Brackin, Theodrian, Ungy, Bungy, valdis, Vincent, Madaire-Cullen, Wayne, culbert, Wild, Bill, Will, Osboldstone, William, Richardson, Yongdian, Guo, Your, Husbando, zoobot5, Профессор Преображенский, and 凱 陳 for supporting my work!</p>
			`;
			document.getElementById('output').innerHTML +=`
			...
			document.getElementById('output').innerHTML +=`
				<p class="choiceText" onclick="window.location.href='https://www.patreon.com/posts/32506352'">Download the game</p>
