	...
	switch(scene) {
		case "start" : {
			document.getElementById('output').innerHTML +=`
				<p class = "centeredText">Lastest News 4/16/2020</p>
				<p class = "centeredText">Hentai University v9 will release on the 17th, and here's the a reveal of the secret project I've been working on: https://www.patreon.com/posts/36087265</p>
