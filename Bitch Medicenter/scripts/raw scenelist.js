...
PSAs {
	Welcome to the Medicenter {
		define doctor = sp Doctor; img scripts/gamefiles/none.png;
		t Playback begins, showing a much younger-looking lizF standing next to a doctor. The video is quite outdated.
		doctor Hiya, and welcome to the Fine Lady Medical Institute! If you're watching this, welcome to the team! Say hi!
		t lizF walks forwards, holding a wobbling tray. There's an abrupt cut and lizF is holding a new tray, her white dress looks stained. 
		liz H-hello! Welcome!
		doctor Whether you're a physician, a technician, or even just an intern like lizF here, you're a part of the family. Let me show you around!
		t The camera cuts to the doctor and lizF standing in front of a large machine.
		...
		t The camera cuts to lizF holding a scalpel and a bag filled with a blue dust.
		liz Is this really necessary? This seems dangerous...
		doctor Then do it properly in one take, intern. Alright, rolling in three, two...<br>Here's lizF hard at work, but accidents can happen to everyone!
		...
		t The camera cuts to the doctor standing over a bound, naked lizF.
		im
		...
		sp docter; God damn shithole'll be under in a week. God I can't wait until I can quit.<br>Wait, were we rolling?
	}
	What is a living dildo {
		t The video begins with a shot of just lizF sitting in a stool under a spotlight, cradling an extremely lifelike dildo in her arms.
		t Hello, and welcome back to Talking Today. Today we have with us lizF, a physician from Bitch Medicenter, here to talk to us today about living sex toys.
	...
	Bimbo Dust {
		t Playback begins in a skatepark, lizF rolls onscreen wearing all the appropriate safety gear.
		...
		t lizF holds up a small bag of white powder.
		...
		t The camera returns to lizF, now wearing an askew baseball cap with the word "NO" written on it.
	...
	Hypermeth {
		t The video opens of a solemn shot of lizF on a chair.
		liz Hi. My name's lizF and if you're under the age of twenty-seven your generation is experiencing the biggest drug epidemic this century. And it's mostly because of this little bad boy right here.
	...
	Princess Quest {
		t This is a short film on the anatomical accuracy of a game's scenes, and how possible they are with modern technology. The video begins with lizF sitting in an office chair with a computer screen displaying a Japanese game.
...
Wife {
	Interview {
		define wife = sp wife; img images/scripts/gamefiles/profiles/wife.jpg;
		...
		wife wifeF. My husband won't shut up about wanting sex. How many times do I need to repeat it? You only had me write it down fifty times. 
	...
	B {//Bimbofication
		...
		t wifeF pushes past lizF and makes her way out the door.
	...
	BB {
		t It's been several days since her operation, and the fuzz clouding wifeF's mind has only grown stronger.
		...
		sp wife; <i>Focus, wifeF... God, why does it still feel like I'm forgetting something?</i>
		im
		...
		im
		t But what really matters is wifeF's opinion, and if she weren't giggling vapidly at how nice sperm feels on her face, she'd give the medicenter a glowing recommendation, albeit with a limited vocabulary.
	}
}

Girlfriend {
	Interview {
		define girlfriend = sp Kylie; img = images/scripts/gamefiles/profiles/girlfriend.jpg;
		define boyfriend = sp Michael; img = images/scripts/gamefiles/profiles/boyfriend.jpg;
		...
		liz We aren't Bodymodz, our modifications can potentially be undone. Let's get the two of you prepped, alright?
	}
	A {//Dickgirl & trap
		define girlfriend = sp Kylie; img = images/scripts/gamefiles/profiles/girlfriendPost.jpg;
		define boyfriend = sp Michael; img = images/scripts/gamefiles/profiles/boyfriendPost.jpg;
		t Soon after, Liz walks into the room.
		liz How are my two sleeping be-<br>... Hello? Did I get the wrong room?
	}
	AA {
	...
	B {//Femdom
		...
		define boyfriend = sp Michael; img = images/scripts/gamefiles/profiles/boyfriend.jpg;
		girlfriend Mmm...
		t girlfriendF gently opens her eyes to the sight of the resting room. She doesn't feel different, although she does see her boyfriend resting on the table across from her.
		girlfriend boyfriendF, hey. Cmon, get up.
		boyfriend Mmm...
		liz Do I hear a pair of love birds chirping away?
		t lizF excitedly bursts into the room.
		liz Good morning! How do you feel?
		boyfriend Tired.
		girlfriend The same as before, actually.
		liz The effects should be subtle at first. You'll notice changes as the days go by. Treat this as a course correction instead of a new direction and you should be surprised soon enough. To be direct, most of the changes were made to boyfriendF's mind and body. 
		...
		t The car ride has been uneventful so far, although every so often when boyfriendF glances to the side he sees girlfriendF staring back at him, almost... Hungry.
		...
		t Despite his tone boyfriendF finds himself pulling over anyways.
	}
	BB {
		define boyfriend = sp Michael; img = images/scripts/gamefiles/profiles/boyfriendTrap.jpg;
		t boyfriendF sighs and lays back on his bed. Every time he and girlfriendF go out shopping his room seems to get a little... Fluffier. His fashion sense, his style, even the way he looks has been changing pretty quick, and he's been weirdly receptive to it all.
...
Jock {
	Interview {
		define jock = sp John; im scripts/gamefiles/profiles/jock.jpg;
		...
		jock Right... My name is jockF, and I've got a small dick.
		...
		liz Whatever you think is best is what I'll go for. I wanna wake up different, somebody who can maintain a relationship.
	}
	A {//Sissification
		define jock = sp Jenny; im scripts/gamefiles/profiles/jockTrap.jpg;
	...
	AA {
		...
		t The woman between his legs giggles as he squirts another thin load of sweet cum into her mouth. 
	...
	B { //M to F
		define jock = sp Jenny; im scripts/gamefiles/profiles/jockGirl.jpg;
...
Milf {
	Interview {
		define milf = sp Lisa; im scripts/gamefiles/profiles/milf.jpg;
	...
	A {//Hypervirile son
		...
		t After a few moments of milfF showing her gratitude and being shocked at the low cost of the treatment, the mother and her son head home. 
		t ... 
		milf He's sleeping so peacefully... Oof! You've gotten a lot heavier too! I remember when I could... Hmmrg... Hold you in my... Arms! 
		t milfF manages to carry her son out of the car. Curiously despite not being particularly close to any of them, some of the other moms in the neighborhood offer to help carry the weight. Each of them in their own slightly unsettling way lets milfF know they'd love to come by and offer their well wishes to her son once he's awake. 
		milf <i>Strange... I didn't know any of them cared about me or my son...</i>
		t Once she's inside the group of mothers set down sonF on the bed. A few of them seem hesitant to leave, but reluctantly do so once milfF promises to keep them updated. 
		t Exhausted, milfF strips down and falls asleep in her own bed. 
	}
	AA {
		t milfF awakens to the smell of food. A real breakfast, not the five-minute cereal meal and bruised orange she usually makes. She smiles contentedly as the scent of bacon wakes her up, only for her to jerk up as she realizes her husband is gone and her son can't cook. 
		...
		t milfF pulls out a chair and takes a seat, but jumps a little in shock as she sits down.
		...
		t He keeps going on, but eventually milfF starts to tune him out. His enthusiasm is infectious and she's happy he's improving, but there's something unmistakably wrong about the feeling in her chest whenever she looks at him. 
		...
		t Her body quivers and shakes, fluid drips through fabric onto the dining room floor, the look of disgust in his eyes being enough to trigger an orgasm. 
		im 
	}
	AAA {
	...
	B { //Dropped for time
		define milf = sp Lisa; im scripts/gamefiles/profiles/milf.jpg;
		t Light floods her eyes and the sound of a beeping monitor pulls a half-awake milfF back to reality.
		liz Good morning~! Snapped out of your daze yet? Hypnosis often leaves people feeling quite groggy.
		milf I don't... Feel any different? What does being a master negotiator even feel like?
		liz The changes are mostly mental, and are very subtle. Just intervene and talk it out, and follow your instincts. Everything will work out after that, for your treatment our guarantee policy is.
		milf ... Is?
		liz It is. As in, it exists. No comment past that point. Give us a call afterwards if the situation doesn't change.<br>Our technician is quite skilled, I'm sure everyone will be satisfied in the end.
		t Though she still seems uncertain, Lisa just nods and gathers her things.
	}
	BB {
		milf What am I doing...? "Trust your instincts", more like "Get out of here before you realize you were ripped off"...
		t A nervous milfF waits at an unfamiliar door. She had some reservations about using the internet to find someone's home, and even more reservations about actually confronting her son's bully herself, but it was clear the bullying was affecting her son's life. He'd come home with bruises, he'd be less enthusiastic around the house, and he was masturbating far more oft-
		t As the door opens milfF's thoughts fade. The boy who opens the door is even shorter than her son, yet undeniably less scrawny. 
		bully You need something, or are you here just to stand on our porch for another hour?
		
		t It's hard to keep the conversation going at all for milfF, as every single fiber of her body screams out in motherly instinct telling her to nurture, even coddle the boy in front of her. 
		t As the effects of her alteration at the medicenter finally take a hold of her instincts, her voice of reason dies down from a panicked frenzy to a distant whisper. 
		milf How about... I make you a deal? No more roughhousing with sonF... And in exchange you get a brand new mommy? 

	}
	BBB {
		t As has become the usual morning ritual milfF prepares to give bullyF his morning kiss by kneeling down, closing her eyes, and puckering her lips as bullyF slides down his pants.
		t Any good mother would be horrified at the prospect of showing such absolute submission to her son's bully. Any decent woman would be horrified at the feeling of her lips pressing against the rim of a puckered asshole.
		im
		t But milfF just moans, thrusting her tongue forwards in an act of worship to the virile male before her.
		t Her makeup already ruined and lipstick more visible on bullyF's asshole than her own lips, she raises herself from her kneeling position to walk over to her other son. She takes him by the chin and the two lock lips. 
	}
}

Schoolboy {
	Interview {
		define schoolboy = sp Danny; im scripts/gamefiles/profiles/schoolboy.jpg;
	...
	A {//Watersports
		define schoolboy = sp James; im scripts/gamefiles/profiles/schoolboy.jpg;
		...
		liz Good morning~! 
		t lizF enthusiastically strides into the room.
		...
		t Fantasies of bouncing on a fat dildo to an emasculating squirtgasm are interrupted as lizF grabs his attention by waving a finger in his face. 
	...
	AA {
		...
		im
		t Slowly, schoolboyF lowers himself onto the dildo until he can feel the balls against the rim of his ass. The pressure of his squished prostate causes his flaccid dick to leak a clear fluid. A side-effect of the treatment is that his pee and cum have both become so clear he can't distinguish the two.
		...
		t Slowly, schoolboyF lifts himself back up, and that resistance cracks, breaks, and is then shattered as schoolboyF mashes his prostate and the back of his bladder with the fat head of the sex toy.
		t schoolboyF squeals as the floodgates are broken. While he doesn't know if it's piss or cum, he does know what his mind instinctively calls it.
		...
		t The growing pool beneath his feet shows that schoolboyF will be becoming very acquainted with these effects in the coming months.
		...
		im 
	}
	B {//Sissification + watersports
		define schoolboy = sp Danny; im scripts/gamefiles/profiles/schoolboy.jpg;
		...
		t lizF sighs, and gently takes schoolboyF's dick in her hands. He gasps at the touch, his urethra winking open then closed as he grunts in exertion trying to hold back.
		...
		t lizF kneels down, planting a kiss on schoolboyF's midsection.
		...
		t He gasps, barely holding on. lizF leans in close to whisper into his ear.
		...
		t But instead lizF releases his member and stands up, collecting her clipboard and opening the door.
...
Runner {
	Interview {
		define runner = sp Marie; im scripts/gamefiles/profiles/runner.jpg;
		t Playback begins, a very fit young woman in a sports bra and shorts is sitting on the patient bed.
		liz Could you repeat that for the camera real quick?
		...
		t runnerF shyly plays with her hair, lizF just smiles in response.
	...
	AA {
		...
		t Suddenly she's grabbed as runnerF takes her by the hair, forcing her to down her knees.
		im
		runner Cmon! It's hitting me! 
		t Ashley just mumbles an "Mhmm" as best she can, happy to enjoy the morning routine of her friend turned fuckbuddy even as her nose is mashed against runnerF's clit.
		t What she did wasn't something a good friend would do, but it was something a horny friend would do. Convincing runnerF to go was a hassle, but the "punishment" she got as a result has been worth it.
		im
		runner Deeper... Ghh... I should take you there myself, do to you what they did to me...
		t Ashley just moans into runnerF's muff at the thought.
	}
}

Streamer {
	Interview {
		define streamer = sp Mandy; im scripts/gamefiles/profiles/streamer.jpg;
		...
		t The interview is already in motion, a frustrated lizF crumples up an interview log and throws it aside to start fresh. A young woman is using a pair of chairs like a therapist's couch.
	...
	A {//Exhibitionism
		define streamer = sp Mandy; im scripts/gamefiles/profiles/streamer.jpg;
		t A dazed streamerF is laying on a bed, her eyes open but awareness still asleep, until lizF snaps her fingers bringing her back to reality.
		...
		t streamerF leaves and lizF waves her off, before lizF takes a seat at the room's computer to search something.
	...
	AA {
		...
		im
		t Everything slows down, and streamerF's awareness slowly returns to her body as she feels a damp sensation from her lower body.
	...
	AAA {
		...
		streamer "Would I recommend them?" Of course! Actually, I was maybe thinking of dropping by again soon~<br>I wanna turn up whatever they did for me so that the meet & greet is extra fun!<br>"Chat's moving so fast nobody will know I'm gay"? Saw that! Ooh, another one's cumming!
		t It turns out all she needed was a bit of confidence all along.
	}
}

Anomaly {
	Interview {
		define boss = sp Mrs. Jensen; im scripts/gamefiles/profiles/boss.jpg;
		...
		t lizF is interrupted as the woman pulls an old gold coin from her pocket.
...
Rainy {
	Interview {
		define unknown = sp Parasol Representative; im scripts/gamefiles/profiles/parasol.jpg;
...
Alteration {
	Interview {
		define sub = sp ???; im scripts/gamefiles/profiles/sub.jpg;
...
Catgirl {
	Interview {
		define catgirl = sp Daisy; im scripts/gamefiles/profiles/catgirl.jpg;
		...
		t lizF reaches forwards towards catgirlF's head. 
		s catgirl; Of course! 
		t catgirlF leans her head down, allowing lizF to inspect her ears. Even the lightest touch is enough to get catgirlF's right foot tapping on the floor.
		s catgirl; Aww yeah, that's the spot... 
		t lizF maintains a professional air as she meticulously examines catgirlF, even as it's clear her patient could probably get off on the treatment.
		s liz; The ears are astounding, truly masterwork. 
		t lizF Softly blows on the thin fur, causing catgirlF to let out a squeak. 
		...
		t To prove her point lizF reaches out to begin fondling catgirlF's ears again. This time instead of a careful  examination it's a passionate groping, gently stroking and lightly tugging the fuzzy ears. 
	...
	AA {
		...
		t The stream starts and the chatbox flies by. catgirlF looks excited, and reaches off the side of her bed to lift up a dildo larger than her torso, which she nuzzles affectionately.
		...
		t Wasting no time catgirlF slides down the pole, inches go by as her asshole swallows more and more plastic dickflesh.
		...
		t The stream goes crazy, and to cap off the moment catgirlF pushes down a little further so that every detail of the reverse-deepthroat can clearly be seen until the rim bumps up against the back of her teeth. The audience is treated to quite the show as her tongue dances around in her mouth around the toy.
	...
	BB {
		...
		t The stream starts and the chatbox flies by. catgirlF grins smuggly and her ears twitch in appreciation.
...
Junkie {
	Interview {
		define junkie = sp Jen; im scripts/gamefiles/profiles/junkie.jpg;
	...
	AA {
		...
		t The entire room is nearly fogged over, the smell of sweat and cum is so thick in the air it's visible. Yet the head researcher lizF is unfazed.
		...
		lizF pulls out a number of tools. Whether they look terrifying or arousing enough to make you leak on sight is entirely subjective.
		...
		t lizF holds up a remarkably realistic looking fleshlight. So realistic in fact that as lizF strokes the lips of the toy, it quivers slightly and leaks a clear line of fluid. On the side of the toy is the word "Daisy". 
		sp junkie; Is that... 
		...
		t True to lizF's word, junkieF has resumed slamming her meat into the extraction machine. Sweat drips down her face as her overworked balls gurgle to meet her need to cum.
		...
		t lizF kneels down. junkieF is wantonly thrusting against the machine, her fat pair of inhumanly thick balls swinging in the air. lizF flips a switch on the machine, causing junkieF to stop in surprise as, at the moment she's balls deep, the machine comes to life. Hundreds of small, soft nubs, a rhythmic pulsing, and a gentle suction activate to stimulate her foot-long horsecock. 
		t As junkieF moans and her legs quiver, lizF gentle cradles one of her fat balls. 
		...
		t The thought pushes junkieF over the edge, her balls tightening hard enough that the cradled nut is lifted from lizF's hand. She shatters her previous output record as a splortching sound fills the room louder than the whrrr of the extraction machine. 
		sp lizF; That's... Four and a half liters, fantastic! See? With only a month of abstinence and a top of the line semen-slurper machine you had no trouble at all meeting your quota. Feel free to splurt as much as you like for the month, so long as you can make next month's quota of course. Ah, and if you do bring your friend please be sure to recommend our bodymod services as well. 
		t junkieF just nods absentmindedly as she staggers back, her brain totally fried from six consecutive orgasms after holding back for so long. Despite her exhaustion though, it's clear having another session with the amazing machine is the only thing her mind. 
	}
	B { //Prostate Enhancement
		define junkie = sp Jen; im scripts/gamefiles/profiles/junkie.jpg;
	...
	BB {
		...
		t Every time junkieF comes in for a routine checkup, she leaves with a hundred snippy remarks bouncing around in her head, all of them left unsaid, as the only thing she can actually manage to say is...
		junkie Guuuhd~! I can feel mushing my prostate~!
		t A torrent of backed-up jizz splatters onto the floor, the mess has a consistency similar to long worms made from jelly. They pile up beneath junkieF's cock, not pooling like normal sperm would.
		t A quick snack from lizF tells her what she needs to know. The way she slurps up a strand of cum is very professional.
		t This is the forth checkup in two months. junkieF should know how to effectively relieve herself by this point, but something about lizF's technique...
		t She certainly wasn't failing to get off enough on purpose or anything, just so she could have lizF completely crush her bitch-button of a p-spot. That would be rediculous.
		liz Tsk tsk, I can taste that you're pent up. Is your prostate bigger than before?
		t junkieF's only answer is to wantonly moan out a string of obscenities, pushing her hips back to thrust in just a few more inches of the veiny, studded dildo stuffed up her asshole.
		...
		t lizF gently places her palm over a bloat in junkieF's midsection and draws back the dildo. In one smooth motion she thrusts back in and presses on the bulge, assaulting junkieF's prostate from both sides. What junkieF screams out as her wagging cock spurts even more cum can't be described as words, let alone anything resembling english.
	...
	CC {
		t A few weeks after her treatment junkieF rubs her eyes, waking up to a very familiar morning scene.
