...
function writeEncounter(scene) {
	...
	switch (scene) {
		case "start" : {
			...
			// replace [\r\n]+ with , 
			writeText("Thank you to: Swallows999, Joshua Ingram, Madgunner, Robbie, Lasse B, andres mejia, Badaxe, ChronosEdge, Colin E, Dkells, Dustin Leichsenring, FearlessViper26, Filament, G, J_C_L, jack spencer, Jinouga, Marco Wassmer, maxime, Ramsey Bisher, Scal, Taylor Trout, XxrobothacksxX, Aegil, Andy, Angel, Anthony Munso, Ariados, Arthur radcliffe, AxiosMIles, Bawornnan samart, Blaise Fenn, Bonelessunknown, brandon, Carlos, Chaaaanon, Charles Morris, Colin, Danny Nguyen, Darrell Goodman, Debarre Sonny, dhccpmc, Drashin, Dugelle, Grim2011, Guy68691, Gwen Yurick, ItsAllOgreNow, Jane, Jesse Greene, joe, John Lewis, john smith, Joseph Gibbs, Joshua Melzark, KH dg, lm Carma, mazterlith, Monkey, murgatroid99, Nils Maier, Noah, Nutburger, Phanes, Prodigal211, ptw1985, qwerty, Roy, Scumstango, Sebastian Eckel, Simon Rencher, sky, Snaked, stratum, Taurus Travon Rashad Lemar Brackin, Trevor, Vincent Madaire-Cullen, Wayne culbert, Wei, Wild Bill, William Richardson, Your Husbando, Z, สิรวิชณ์ อาสว่าง, 凱 陳, and 魏, for funding this work! The patreon funds are split as Captain Cryptogreek has taken over as lead writer for the game.");
