...
function writeEncounter(scene) {
	...
	switch (scene) {
		case "start" : {
			...
			// replace [\r\n]+ with , 
			writeText("Thank you to: Swallows999, Joshua Ingram, Robbie, CaptainMontana, Lasse B, andres mejia, Arthorias28, Badaxe, ChronosEdge, Colin E, Dkells, Filament, J_C_L, Jinouga, Marco Wassmer, maxime, Ramiel Palomino, Scal, Taylor Trout, XxrobothacksxX, Aegil, andy, Andy, Andy Amundy, Angel, Anthony Munso, Ariados, Arthur radcliffe, AxiosMIles, Bawornnan samart, Blaise Fenn, Bonelessunknown, brandon, Carlos, Chaaaanon, Charles Morris, Colin, Darrell Goodman, Debarre Sonny, Devin, dhccpmc, Drashin, Dugelle, Guy68691, Gwen Yurick, ItsAllOgreNow, Jane, jdktjk205, Jesse Greene, joe, John Lewis, john smith, Joseph Gibbs, Joshua Melzark, lm Carma, mazterlith, Monkey, murgatroid99, Nils Maier, Noah, Nutburger, Phanes, Prodigal211, ptw1985, qwerty, Roy, Scumstango, Sebastian Eckel, Simon Rencher, sky, Smiley Green, Snaked, stratum, Taurus Travon Rashad Lemar Brackin, valdis, Vincent Madaire-Cullen, Wayne culbert, Wei, Wild Bill, William Richardson, Your Husbando, Z, zoobot5, สิรวิชณ์ อาสว่าง,  and 凱 陳 for funding this work! The patreon funds are split as Captain Cryptogreek has taken over as lead writer for the game.");
		...
		case "credits": {
			...
			writeText("Thank you to: Swallows999, Joshua Ingram, Robbie, CaptainMontana, Lasse B, andres mejia, Arthorias28, Badaxe, ChronosEdge, Colin E, Dkells, Filament, J_C_L, Jinouga, Marco Wassmer, maxime, Ramiel Palomino, Scal, Taylor Trout, XxrobothacksxX, Aegil, andy, Andy, Andy Amundy, Angel, Anthony Munso, Ariados, Arthur radcliffe, AxiosMIles, Bawornnan samart, Blaise Fenn, Bonelessunknown, brandon, Carlos, Chaaaanon, Charles Morris, Colin, Darrell Goodman, Debarre Sonny, Devin, dhccpmc, Drashin, Dugelle, Guy68691, Gwen Yurick, ItsAllOgreNow, Jane, jdktjk205, Jesse Greene, joe, John Lewis, john smith, Joseph Gibbs, Joshua Melzark, lm Carma, mazterlith, Monkey, murgatroid99, Nils Maier, Noah, Nutburger, Phanes, Prodigal211, ptw1985, qwerty, Roy, Scumstango, Sebastian Eckel, Simon Rencher, sky, Smiley Green, Snaked, stratum, Taurus Travon Rashad Lemar Brackin, valdis, Vincent Madaire-Cullen, Wayne culbert, Wei, Wild Bill, William Richardson, Your Husbando, Z, zoobot5, สิรวิชณ์ อาสว่าง,  and 凱 陳 for funding this work!");
