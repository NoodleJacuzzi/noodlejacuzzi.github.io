...
function writeEncounter(scene) {
	...
	switch (scene) {
		case "start" : {
			...
			// replace [\r\n]+ with , 
			writeText("Thank you to: Swallows999, Iron Diana, Robbie, Joshua Ingram, Godlebay, RatKnight, Elias Errati, ryguy, 4MinuteWarning, Hi There, Carlos, Macarga, 林家豪, Richard, dragoon48, Negativatron, Dustin Leichsenring, G, Ramsey Bisher, jack spencer, J_C_L, Filament, XxrobothacksxX, Dkells, Jinouga, Marco Wassmer, Taylor Trout, andres mejia, Colin E, Badaxe, Jesse Greene, Scal, ChronosEdge, a1214672685, Elijah Hansen, Sergio Prichard, pablo perez, Sera, ggboomsky, CoolFlames, Emily Pajak, Royce, GoblinKing, Bradley Herbert, gabriel, SomebodyElse, dante schraeder, Peter H, DutchJudgement, DifferoBiga, 长平 鬣, Culton Niccum, thesingleguy, Kethis Immortalis, cabbage, colt, Anton Schmidt, david thompson, Jayesonn leleaux, Bleed1ngthunder, Eric Hslew, Don, Vikteren, Dean, Sveny13, Kudon, theoron, AnotherAccount333, Gavin Davis, Lucas, Kaliden, Krose, Tyler Ross, greatred, FrostyTB, Riven Drasek, l, ranchy sanchy, TheRawToast, Limitless, Greg Torres, KVBismarc, Geoff Heimos, liam paterson, ChubbiestThread, Reverberations, ShadowFalls, William Parker, Magnus, Emanuel  Garcia, XaiuX, Kieron Kow, Slomberg, henry grobins, ddkre, SmolFish, I'm a Mitch, GirmusCz, Anthony Ewing, Daniel Vivette, Harry Brasch, Daekash, fireballcreations, Markus Hansen, Louis Hayes, Tanman, DarthMalak, Danny Nguyen, yami, Grim2011, Darrell Goodman, Z, John Lewis, Bonelessunknown, Phanes, Scumstango, Aegil, Wei, Dugelle, CaptainMontana, Simon Rencher, dhccpmc, Chaaaanon, Charles Morris, Nutburger, Whynot, William Richardson, mazterlith, Anthony Munso, john smith, Your Husbando, Carlos, Joshua Melzark, Verillia tristari, ItsAllOgreNow, Gwen Yurick, Nils Maier, Blaise Fenn, stratum, Angel, Ariados, Jane, Snaked, Debarre Sonny, Drashin, qwerty, murgatroid99, Roy, Wild Bill, and brandon, for funding this work! The patreon funds are split as Captain Cryptogreek has taken over as lead writer for the game.");
		...
		case "credits": {
			...
			writeText("Thank you to: Swallows999, Joseph, Joshua Ingram, Robbie, 4MinuteWarning, 林家豪, andres mejia, Badaxe, Carlos, ChronosEdge, Colin E, Dkells, dragoon48, Dustin Leichsenring, Elias Errati, G, Hi There, Iron Diana, J_C_L, jack spencer, Jinouga, Liam M, Marco Wassmer, Matthew Landin, maxime, Negativatron, Ramsey Bisher, Richard, ryguy, Scal, ShadowFox, Taylor Trout, that GUY, Aegil, Ally Smith, Angel, AnotherAccount333, Anthony Ewing, Anthony Munso, Anton Schmidt, Ariados, Billymays, BINKS, Blaise Fenn, Bleed1ngthunder, Bonelessunknown, Bradley Herbert, Brandon, brandon, Brandon Leary, Brent Roberts, CaptainMontana, Carlos, Chaaaanon, Chris Rucker, ChubbiestThread, colt, commyboi, Culton Niccum, Daekash, Daniel Vivette, Danny Nguyen, Darien Cordero, Darrell Goodman, DarthMalak, david thompson, ddkre, Dean, Debarre Sonny, dhccpmc, Don, Donovan Korpa, Drashin, Dugelle, 长平 鬣, Elijah Hansen, Emily Pajak, Eric Hslew, Erin Trippet, Ethan Brian, fireballcreations, Firestar99255, FrostyTB, Funnykitty, gabriel, Genxin, Geoff Heimos, ggboomsky, GirmusCz, greatred, Greatsage56 ., Greg Torres, Grim2011, Gwen Yurick, Harry Brasch, henry grobins, HolyDurandal, I'm a Mitch, iokknardnerus, ItsAllOgreNow, Jane, Jay Mee, Jayesonn leleaux, Jesse Greene, John Lewis, John Nixon, john smith, john sparks, Johnathan Thornburg, Johnny Mind, Kaliden, Kethis Immortalis, Kieron Kow, Kudon, KVBismarc, l, l1monat, liam paterson, Limitless, Louis Hayes, Magnus, Markus Hansen, Marvis, mazterlith, Me Notyou, mpop, murgatroid99, nathan, Nils Maier, Noh Bhodie, Nutburger, Patrick, Peter H, Phanes, poyo, qwerty, ranchy sanchy, RatKnight, Reverberations, Richard Pryor, Roy, Sam Schneck, sb2017, scott, Scumstango, Seamus Porter, Sean Morehead, Sera, Sergio Prichard, ShadowDragon, ShadowFalls, Simon Rencher, Skyrim mod lvr, Slomberg, SmolFish, Snaked, SomebodyElse, Sub Lyminal, Tanman, theoron, thesingleguy, Tyler Ross, Verillia tristari, Vikteren, Wei, Whynot, Wild Bill, William Parker, Wysdom, XaiuX, yami, Your Husbando, Z, and Zane regel for funding this work!");
			writeSpecial("Special thanks to stiggy752 for the game's CSS, Wild Bill/Master of Puppets for the game's save to file system, and to OrangeMaestro for his orange eyes helping find many of the typos that plagued this game.");
