...
var encounterArray = [//Lists encounters as they appear on the map. Nonrepeatable, only one per day per character by default.
	...
	{index: "greenQuo", name: "green is hanging out in scarf's office", location: 'teacherLounge', time: "MorningEvening", itemReq: "", trustMin: 41, trustMax: 41, type: "tab", top: 0, left: 0, day: "both",},
...
function writeEncounter(name) { //Plays the actual encounter.
	...
	switch (name) {
		...
		case "greenBar2": {
			writeEvent("greenBar");
			writeSpeech("scarf", "", "Not a bad plan-");
			writeBig("imagebox/scarf/scarfCasual.jpg", "Art by Enoshima Iki");
			writeSpeech("player", "", "Jesus!");
			writeSpeech("scarf", "", "Oh, is that what I look like to you? Well, she's out. There's pretty much no chance that she'll remember any of this in the morning you know.");
			writeSpeech("player", "", "Well, failures could go worse, I suppose.");
			writeSpeech("scarf", "", "Care for a nightcap?");
			...
			writeSpeech("scarf", "", "Take your time~");
		...
		case "greenHome1": {
			...
			writeSpeech("green", "", "Yo! Food's ready. Hope you don't mind I got a little more comfortable.");
			writeBig("imagebox/scarf/greenCasual.jpg", "Art by Enoshima Iki");
			writeSpeech("player", "", "Thanks. This yours?");
			writeSpeech("green", "", "Nope! scarfF's.");
			writeSpeech("player", "", "Why would she need a book on snapping? She sounded fine before.");
			writeSpeech("green", "", "Dunno why, but she said she needed to sound consistent. Honestly, she practiced so much I can still hear it when I go to sleep.<br>Helpful tip, I fuckin' hate the sound. No faster way for your ass to hit the street.");
			writeSpeech("player", "", "I'll keep it to myself then.");
			writeSpeech("green", "", "Ah, you're fine, doesn't hit those notes that fuck me right up. You don't got that echo-y sound afterwards. Now stop snoopin' through boring shit and come eat.");
			writeFunction("writeEncounter('greenHome2')", "Continue");
			break;
		}
		case "greenHome2": {
			writeEvent("greenHome");
			writeSpeech("green", "", "Hehe, maybe for an appetizer, I got at-");
			writeSpeech("scarf", "", "I'm hooooome~");
			writeSpeech("green", "", "Ah, she's back.<br>Fuck off sis, I'm havin' some me time! Go back with your little boytoy!<br> How the hell is he convinced you're a teenager too, anyw-");
			writeText("*SNAP*");
...
function writeEvent(name) { //Plays the actual event.
	...
	switch (name) {
		...
		case "greenHome": {
			...
			writeSpeech("green", "", "Fuck? That's the plan, lemme finish first though.");
			...
			writeSpeech("green", "", "Sorry, couldn't hear you over the massive erection you're popping right now.<br>And if she does come home, who cares? She's pretty freaky anyways, honestly. We've lived together for years, we've seen it all at this point.");
			writeText("You just shrug your shoulders and decide to roll with it all.");
			writeSpeech("green", "", "Now, you gonna stand there, or-");
			writeBig("imagebox/scarf/scarfHome1.jpg", "Art by Enoshima Iki");
			writeSpeech("green", "", "Ohoh, you take what you like, don't you?");
			writeSpeech("player", "", "I take what I want.");
			writeSpeech("green", "", "You got the swagger of a much bigger *man, playerF. Hope you got the technique to back that up.");
			writeBig("imagebox/scarf/scarfHome2.jpg", "Art by Enoshima Iki");
			writeSpeech("green", "", "Nnngh-!");
			writeSpeech("player", "", "Not so cocky now, are you?");
			writeSpeech("green", "", "Any... Any bozo off the street can thrust, jackass. Gimme a good time or I'll wipe that smirk off that pretty face.");
			writeSpeech("player", "", "You can't even see my face, how do you know I'm grinning?");
			writeSpeech("green", "", "I can hear it, now HARDER~!");
			writeText("...");
			writeBig("imagebox/scarf/scarfHome3.jpg", "Art by Enoshima Iki");
			writeSpeech("green", "", "Ooough~!");
