var character = {index: "sports", fName: "Zoe", lName: "Parker", trust: 0, encountered: false, textEvent: "", met: false, color: "#496EBF", author: "SlackerSavior", artist: "Himitsu Kessha Vanitas"};
...
function writeEncounter(name) { //Plays the actual encounter.
	...
	switch (name) {
		...
		case "sportsfinalhome1": {//Titjob Home
			...
			writeFunction("changeLocation(data.player.location)", "You spend the night with her, making sure to use your slave to the fullst before sending her off to school in the morning.");
			break;
		}
...
function writeEvent(name) { //Plays the actual event.
	...
	switch (name) {
		...
		case "sports7d": {//Take her home
			writeText("She moves slowly at first, still shaky from her fist ass fucking, but she knows what it is you want.");
