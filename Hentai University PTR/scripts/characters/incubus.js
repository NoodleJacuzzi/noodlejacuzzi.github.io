		...
		case "statusQuo": {
			...
			if (checkTrust('incubus') == 2) {
				...
				if (checkFlag('incubus', 'rimjob') == false) {
					sale("rimjob", 40, "imagebox/incubus/rim1.jpg", "Rimjob<br>High virility customers only, masculine or boyish bodies preferred");
				}
				else {
					sale("rimjobRepeat", 40, "imagebox/incubus/rim5.jpg", "Rimjob (REPEAT)<br>High virility customers only, masculine or boyish bodies preferred");
				}
			}
	...
	switch (name) {
		...
		case "incubusrimjob": {
			writeHTML(`
				...
				sp incubus; Oh ghhhd!
				t Her eyes roll back and she grits her teeth, the sweet smell filling the room grows more intense and she clenches your thighs hard to hold back from stroking herself, trying to keep herself on edge for as long as possible.
