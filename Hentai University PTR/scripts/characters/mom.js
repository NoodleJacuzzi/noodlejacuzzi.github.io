...
var encounterArray = [//Lists encounters as they appear on the map. Nonrepeatable, only one per day per character by default.
	...
	{index: "momCasino1", name: "mom is here in a strange outfit", location: 'casino', time: "MorningEvening", itemReq: "", trustMin: 90, trustMax: 200, type: "tab", top: 0, left: 0, day: "both",},
]
...
function writeEncounter(name) { //Plays the actual encounter.
	...
	switch (name) {
		...
		case "momCasino1": {
			...
			writeSpeech("scarf", "", "Relax... Let yourself sink in and enjoy~");
