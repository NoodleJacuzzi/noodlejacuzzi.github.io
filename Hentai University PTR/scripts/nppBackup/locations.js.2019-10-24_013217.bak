var locationArray = [
	...
	{index: "street", buttons: [
		...
		{name: "Park District", top: 80, left: 75, type: "location", target: "parkDistrict", time: "MorningEvening",},
		{name: "Vintage Street", top: 58, left: 75, type: "location", target: "vintageStreet", time: "MorningEvening",},
	...
	{index: "northHallway", buttons: [
		{name: "Your Office", top: 70, left: 75, type: "location", target: "playerOffice", time: "MorningEvening",},
		{name: "Teacher's Lounge", top: 45, left: 75, type: "location", target: "teacherLounge", time: "MorningEvening",},
	...
	{index: "westHallway", buttons: [
		{name: "Classroom A", top: 50, left: 75, type: "location", target: "classroomA", time: "MorningEvening",},
		{name: "Library", top: 50, left: 50, type: "location", target: "library", time: "MorningEvening",},
		{name: "Cafeteria", top: 53, left: 37, type: "location", target: "cafeteria", time: "MorningEvening",},
