...
var data = {
	...
	story: [
		{index: "mom", name: "Lisa", trust: 0, outfit: "Old", flags: "",},
		{index: "sister", name: "Jean", trust: 0, outfit: "", flags: "",},
		{index: "friend", name: "Riley", trust: 0, outfit: "", flags: "",},
		{index: "teacher", name: "Kendra", trust: 0, outfit: "", flags: "",},
		{index: "chef", name: "Ava", trust: 0, outfit: "", flags: "",},
		{index: "office", name: "Alexis", trust: 0, outfit: "", flags: "",},
		{index: "exotic", name: "Adriana", trust: 0, outfit: "", flags: "",},
		{index: "clothes", name: "Gina", trust: 0, outfit: "", flags: "",},
		{index: "candy", name: "Jynx", trust: 0, outfit: "", flags: "",},
		{index: "bully", name: "Lexi", trust: 0, outfit: "", flags: "",},
		{index: "evil", name: "Bonnie", trust: 0, outfit: "", flags: "",},
		{index: "camboi", name: "Avery", trust: 0, outfit: "", flags: "",},
		{index: "neighbor", name: "???", trust: 0, outfit: "", flags: "",},
		{index: "doll", name: "Rubilocks", trust: 0, outfit: "", flags: "",},
	],
	inventory: [],
	gallery: [],
}
...
function setToDom() {
	data.player.body = originalBody;
	changeOutfit("mom", "");
	changeOutfit("sister", "");
	changeOutfit("friend", "");
	changeOutfit("teacher", "");
	changeOutfit("chef", "");
	changeOutfit("office", "");
	changeOutfit("exotic", "");
	changeOutfit("bully", "");
...
function setToSub() {
	originalBody = data.player.body;
	data.player.body = "sub";
...
function renameCharacter(target, scene) {
	switch (target) {
		...
		case "demo":
			...
			data.player.name = goof;
			for (i = 0; i < data.story.length; i++) {
				if(document.body.contains(document.getElementById('nameSubmission'+data.story[i].index))){
					var sheet = 'nameSubmission' + data.story[i].index;
					data.story[i].name = document.getElementById(sheet).value;
				}
			}
		break;
